...
//
//    @Override
//    public Optional<AdministratorDTO> getAdministrator(long userId) {
//        return administratorRepository.findByUserId(userId).map(AdministratorDTOConverter::convertToDTO);
//    }
//}
